<?php
// Incluir o arquivo de serviço de autenticação
require_once __DIR__ . '/src/services/AuthService.php';

// Verificar se o usuário está logado e redirecionar se não estiver
AuthService::checkSessionAndRedirect();
?>
                    ...
                    <nav class="pcoded-navbar">
                        <div class="nav-list">
                            <div class="pcoded-inner-navbar main-menu">
                                <div class="pcoded-navigation-label">Menu Principal</div>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    <div class="page-body">
                                        ...
                                        $pag = [];
                                        $pag[1] = "inicio.php"; // Dashboard principal
                                        ...
                                        // Usuários
                                        $pag[18] = "usuarios/cadastro.php";
                                        $pag[19] = "usuarios/lista.php";
                                        $pag[20] = "usuarios/editar.php";
                                        $pag[21] = "usuarios/excluir.php";
...
<![endif]-->
    ...
    <script src="assets/js/rocket-loader.min.js" data-cf-settings="2d8d78e876b340f9029c575b-|49" defer=""></script>
</body>
