    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5>Bem-vindo ao Sistema de Gestão da Clínica</h5>
            </div>
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-md-3 mb-4">
                        <a href="link.php?route=3" class="text-decoration-none">
                            <div class="card bg-primary text-white h-100" style="cursor: pointer; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                                <div class="card-body">
                    ...
                    <div class="col-md-3 mb-4">
                        <a href="link.php?route=7" class="text-decoration-none">
                            <div class="card bg-success text-white h-100" style="cursor: pointer; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="col-md-3 mb-4">
                        <a href="link.php?route=11" class="text-decoration-none">
                            <div class="card bg-info text-white h-100" style="cursor: pointer; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="col-md-3 mb-4">
                        <a href="link.php?route=15" class="text-decoration-none">
                            <div class="card bg-warning text-white h-100" style="cursor: pointer; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                ...
                <div class="row mt-4">
                    <div class="col-md-3 mb-4">
                        <a href="link.php?route=22" class="text-decoration-none">
                            <div class="card bg-danger text-white h-100" style="cursor: pointer; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="col-md-3 mb-4">
                        <a href="link.php?route=25" class="text-decoration-none">
                            <div class="card bg-dark text-white h-100" style="cursor: pointer; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
